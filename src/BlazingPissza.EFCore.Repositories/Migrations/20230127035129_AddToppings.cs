        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Tocino de jabalÃ­", 56.80m },
                    { 4, "Tocino de ternera", 56.80m },
                    { 5, "TÃ© y bollos", 95.00m },
                    { 6, "Bollos reciÃ©n horneados", 85.50m },
                    { 7, "Pimiento", 19.00m },
                    { 8, "Cebolla", 19.00m },
                    { 9, "ChampiÃ±ones", 19.00m },
                    { 10, "Pepperoni", 19.00m },
                    { 11, "Salchicha de pato", 60.80m },
                    { 12, "AlbÃ³ndigas de venado", 47.50m },
                    { 13, "Cubierta de langosta", 1225.50m },
                    { 14, "Caviar de esturiÃ³n", 1933.25m },
                    { 15, "Corazones de alcachofa", 64.60m },
                    { 16, "Tomates frescos", 39.00m },
                    { 17, "Albahaca", 39.00m },
                    { 18, "Filete", 161.50m },
                    { 19, "Pimientos picantes", 79.80m },
                    { 20, "Pollo bÃºfalo", 95.00m },
